...
done < "$HOME/Ubuntu_Setup/packages.txt"
#start syncthing
...
gnome-terminal --tab -- bash -c '/opt/android-studio/bin/studio.sh && echo this is for android studio; exec bash'
